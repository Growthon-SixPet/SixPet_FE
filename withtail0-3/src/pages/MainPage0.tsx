        ...
        <main className="mp0-frame">
          ...
          <section className="mp0-about">
            ...
            <p className="mp0-aboutText">
              WithTail은 반려동물과 보호자의 삶 전반을 함께하는 플랫폼입니다.<br></br>
              질병과 치료가 필요한 순간에는 믿을 수 있는 동물병원을,<br></br>
              이별의 순간에는 정성 어린 장례식장을 안내합니다.<br></br>
              정보의 혼란 속에서 고민하지 않도록 WithTail이 가장 필요한 선택을 돕습니다. <br></br>
            </p>
          </section>
        </main>
